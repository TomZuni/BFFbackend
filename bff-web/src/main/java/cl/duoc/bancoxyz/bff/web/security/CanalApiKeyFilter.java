...
/**
 * Autenticacion propia del canal Web: cada BFF valida una api-key distinta
 * (una por canal), simulando que cada canal tiene su propio mecanismo de
 * acceso hacia su BFF, sin afectar el acceso de los demas canales.
 */
@Component
